...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    ...
    {
        private NhaCungCapBUS           _NhaCungCapBUS;
        private MatHangBUS              _MatHangBUS;
        private HoaDonDatHangBUS        _HoaDonDatHangBUS;
        private ChiTietHoaDonDatHangBUS _ChiTietHoaDonDatHangBUS;
        ...
        private void cbeNhaCungCap_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbeNhaCungCap.SelectedItem.ToString() != null)
            {
                ...
                DataTable dt= _MatHangBUS.LayDanhSachTenMatHangTheoNhaCungCap(MaNhaCungcap, QuyDinhSoSanPhamToiThieu);
        ...
        private void ucHoaDonDatHang_Load(object sender, EventArgs e)
        {
            ...
            {
                string MaNhaCungcap = _NhaCungCapBUS.LayMaNhaCCBangTenNhaCungCap(cbeNhaCungCap.SelectedItem.ToString());
                gcSanPhamDatHang.DataSource = _MatHangBUS.LayDanhSachTenMatHangTheoNhaCungCap(MaNhaCungcap, QuyDinhSoSanPhamToiThieu);
            }
        ...
        {
            DataTable dt = _HoaDonDatHangBUS.LayDanhSachHoaDonDatHang();
        ...
        private void gvKetQua_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            if (dt2 != null && dt2.Rows.Count > 0)
            {
                ...
                if (selectrow != -1)
                {
                    ...
                    DataTable danhsachmathang = _ChiTietHoaDonDatHangBUS.LayChiTietHoaDonDatHangTheoMaHoaDon(mahoadon);
