...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    ...
    {
        private NhaSanXuatBUS nhaSXBUS;
        private NhaSanXuat nhaSX;

        public ucNhaSanXuat()
        {
            InitializeComponent();
            this.nhaSXBUS = new NhaSanXuatBUS();
            //Lấy ds mau sac
            LoadData();
        ...
        private void LoadData()
        {
            ...
            data = this.nhaSXBUS.LayDanhSachNhaSanXuat();
        ...
        {
            String message = "";
            if (nhaSXBUS.XoaNhaSanXuat(gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Mã nhà sản xuất").ToString()))
            {
