...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    ...
    {
        private BaoCaoTonKhoBUS _BaoCaoTonKhoBUS;
        private ChiTietBaoCaoTonKhoBUS _ChiTietBaoCaoTonKhoBUS;
        ...
        public ucBaoCaoTonKho()
        {
            ...
            _BaoCaoTonKhoBUS = new BaoCaoTonKhoBUS();
            _ChiTietBaoCaoTonKhoBUS = new ChiTietBaoCaoTonKhoBUS();
        ...
        {
            DataTable dt = _BaoCaoTonKhoBUS.LayDanhSachBaoCao();
        ...
        private void gvDanhSachBaoCao_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                gcChiTietBaoCao.DataSource = _ChiTietBaoCaoTonKhoBUS.LayChiTietTonKho(mabaocao);
