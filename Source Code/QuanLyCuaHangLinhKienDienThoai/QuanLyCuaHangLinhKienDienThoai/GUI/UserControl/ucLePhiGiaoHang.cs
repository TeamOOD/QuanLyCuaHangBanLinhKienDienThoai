...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    public partial class ucLePhiGiaoHang : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucLePhiGiaoHang()
        {
            ...
            this.gcKetQua.DataSource = (new LePhiGiaoHangBUS().LayDanhSachLePhiGiaoHang());
        }
        ...
        private void sbTimKiem_Click(object sender, EventArgs e)
        {
            ...
            this.gcKetQua.DataSource = (new LePhiGiaoHangBUS().TimKiemLePhiGiaoHang(gh));
        }
        ...
        private void sbThem_Click(object sender, EventArgs e)
        {
            ...
            {
                if ((new LePhiGiaoHangBUS().ThemLePhiGiaoHang(gh)))
                {
        ...
        private void sbCapNhat_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!this.maLePhi.Equals("") && (new LePhiGiaoHangBUS().CapNhatLePhiGiaoHang(gh)))
                {
        ...
        private void sbXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                if (!this.maLePhi.Equals("") && (new LePhiGiaoHangBUS()).XoaLePhiGiaoHang(this.maLePhi))
