...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    ...
    {
        private LoaiMatHangBUS loaiMHBUS;
        private LoaiMatHang loaiMH;

        public ucLoaiSanPham()
        {
            InitializeComponent();
            this.loaiMHBUS = new LoaiMatHangBUS();
            //Lấy ds mau sac
            LoadData();
        ...
        private void LoadData()
        {
            ...
            data = this.loaiMHBUS.LayDanhSachLoaiMatHang();
        ...
        {
            String message = "";
            if (loaiMHBUS.XoaLoaiMatHang(gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Mã loại mặt hàng").ToString()))
            {
