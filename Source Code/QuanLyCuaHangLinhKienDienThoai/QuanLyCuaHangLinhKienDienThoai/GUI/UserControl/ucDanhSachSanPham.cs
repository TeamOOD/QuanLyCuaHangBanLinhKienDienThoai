    ...
    public partial class ucDanhSachSanPham : DevExpress.XtraEditors.XtraUserControl
    {
       ...
       // private Boolean check = false;
        ...
        private void LoadData()
        {
            ...
            data = this.matHangBUS.LayDanhSachMatHang();
        ...
        private void sbThem_Click(object sender, EventArgs e)
        {
            ...
            {
                StaticVariables.addNewTab(new ucThemSanPham(), Name);
            }
        }
        ...
        private void sbTimKiem_Click(object sender, EventArgs e)
        {
            ...
            data = this.matHangBUS.TimKiemMatHang(matHang, kichthuoc, hedieuHanh,
        ...
        {
            StaticVariables.gMatHang = new MatHang();

            if (gridView1.RowCount != 0)//Get data
            {
                DataTable dt = this.GridMatHang.DataSource as DataTable;
                StaticVariables.gMatHang.MaMatHang = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Mã mặt hàng").ToString();
                StaticVariables.gMatHang.TenMatHang = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Tên mặt hàng").ToString();
                StaticVariables.gMatHang.MaLoaiMatHang = dt.Rows[gridView1.FocusedRowHandle].ItemArray[2].ToString();
                StaticVariables.gMatHang.MaNhaSanXuat = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Nhà sản xuất").ToString();
                StaticVariables.gMatHang.SoLuong = Convert.ToInt32(gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Số lượng").ToString());
                StaticVariables.gMatHang.ThoiGianBaoHanh = Convert.ToInt32(gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Thời gian bảo hành").ToString());
                StaticVariables.gMatHang.MoTa = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Mô tả").ToString();
                StaticVariables.gMatHang.GhiChu = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Ghi chú").ToString();
