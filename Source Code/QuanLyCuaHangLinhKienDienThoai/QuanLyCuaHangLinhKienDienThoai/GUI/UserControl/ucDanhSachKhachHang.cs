...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    public partial class ucDanhSachKhachHang : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void sbThem_Click(object sender, EventArgs e)
        {
            ...
            {
                StaticVariables.gKhachHang = null;
                StaticVariables.addNewTab(new ucThemKhachHang(), name);
            }
        }
        ...
        private void LoadData()
        {
            ...
            data = khBUS.LayDanhSachKhachHang();
            this.gridControl1.DataSource = data;
        }

        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            StaticVariables.gKhachHang = new KhachHang();
            if (this.gridView1.RowCount != 0)
            {
                StaticVariables.gKhachHang.MaKhachHang = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Mã khách hàng").ToString();
                StaticVariables.gKhachHang.TenKhachHang = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Tên khách hàng").ToString();
                StaticVariables.gKhachHang.DiaChi = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Địa chỉ").ToString();
                StaticVariables.gKhachHang.SoDienThoai = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Số điện thoại").ToString();
                StaticVariables.gKhachHang.Email = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Email").ToString();
                StaticVariables.gKhachHang.GhiChu = gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Ghi chú").ToString();
            }
        }
