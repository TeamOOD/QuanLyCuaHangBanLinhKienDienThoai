...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    public partial class ucMauSac : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void LoadData()
        {
            ...
            data = this.mauSacBUS.LayDanhSachMauSac();
        ...
        private void sbTimKiemMau_Click(object sender, EventArgs e)
        {
            ...
            DataTable data = new DataTable();
            data = this.mauSacBUS.TimKiemMauSac(mauSac);
        ...
        private void sbThemMauSac_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (this.mauSacBUS.ThemMauSac(ns) == true)
                {
        ...
        private void sbCapNhatMauSac_Click(object sender, EventArgs e)
        {
            ...
            if (this.teTenMau.Text.Equals(""))
            {
                ...
                mauSac.TenMau = this.teTenMau.Text;
                String message = "";
                if (mauSacBUS.CapNhatMauSac(mauSac))
        ...
        {
            String message = "";
            if (mauSacBUS.XoaMauSac(gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Mã màu").ToString()))
            {
