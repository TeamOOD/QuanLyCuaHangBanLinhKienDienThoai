...
{
    public class CauHinhDienThoaiBUS
    {
        private CauHinhDienThoaiDAL cauHinhDienThoaiDAL;

        public CauHinhDienThoaiBUS()
        {
            this.cauHinhDienThoaiDAL = new CauHinhDienThoaiDAL();
        }
        ...
        public CauHinhDienThoai LayCauHinhByMaMatHang(string maMatHang)
        {
            ...
            try
            {
                table = this.cauHinhDienThoaiDAL.LayCauHinhByMaMatHang(maMatHang);
