...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    ...
    {
        private NhaCungCapBUS nhaCCBUS;
        private NhaCungCap nhaCC;

        public ucNhaCungCap()
        {
            InitializeComponent();
            this.nhaCCBUS = new NhaCungCapBUS();
            //Lấy ds mau sac
            LoadData();
        ...
        private void LoadData()
        {
            ...
            data = this.nhaCCBUS.layDanhSachNhaCungCap();
        ...
        {
            String message = "";
            if (nhaCCBUS.XoaNhaCungCap(gridView1.GetRowCellValue(gridView1.FocusedRowHandle, "Mã nhà cung cấp").ToString()))
            {
