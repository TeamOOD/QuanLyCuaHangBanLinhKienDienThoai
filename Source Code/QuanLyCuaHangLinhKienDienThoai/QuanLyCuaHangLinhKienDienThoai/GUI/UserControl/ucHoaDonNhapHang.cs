...
namespace QuanLyCuaHangLinhKienDienThoai.UserControl
{
    ...
    {
        HoaDonNhapHangBUS _HoaDonNhapHang;
        HoaDonDatHangBUS _HoaDonDatHang;
        NhaCungCapBUS _NhaCungCapBUS;
        MatHangBUS _MatHangBUS;
        ChiTietHoaDonDatHangBUS _ChiTietHoaDonDatHangBUS;
        ...
        {
            InitializeComponent();
            _HoaDonNhapHang = new HoaDonNhapHangBUS();
            _HoaDonDatHang = new HoaDonDatHangBUS();
